    ...
    <>
      <section className="pt-[13.9375rem] pb-[7.5rem]">
        <RootWrapper>
          ...
          />
          <div className="mt-12 ">
            <h4 className="text-xl sm:text-2xl md:text-3xl lg:text-[2.625rem] text-black">
              Data-Driven Victories Across India&apos;s Political Landscape.
            </h4>
            <p className="text-base sm:text-lg md:text-xl lg:text-[1.75rem] text-black mt-6">
          ...
          <div className="mt-[4rem] md:mt-[7.1875rem] flex flex-col gap-[3rem] md:gap-[6.8125rem]">
            {caseData.map((study, i) => (
              <div key={i}>
                ...
                <p className="text-black text-base sm:text-lg md:text-xl lg:text-[1.75rem] my-6">
                  {study.description}
                </p>
